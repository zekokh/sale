...
public class SaleShifrinaController {

    private static Logger logger = LogManager.getLogger(SaleShifrinaController.class);
    ...
    Double fontFolderAndProduct = 17.0;
        ...
        if (checkList.size() > 0) {
            ...
            if (check.getGoodsList().size() > 0) {
                ...
                if (check.getDiscount() == null) {
                    ...
                    DiscountProgram.discountOnCountProductInCheck(check, 21, 10, 26.1);
