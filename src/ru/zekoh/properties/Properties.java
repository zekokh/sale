...
public class Properties {
    ...
    public static void initDataWithoutFile(){
        HOST = "jdbc:mysql://localhost:3306/krasnodar1102018?useUnicode=true&characterEncoding=utf8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC&useSSL=false";
        LOGIN = "root";
        PASSWORD = "heroin";
        KKM = true;
        PRINTER_PORT = 3;
